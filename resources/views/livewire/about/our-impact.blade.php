...
<div>
    <div class="grid grid-cols-1 gap-28 h-min">
        <div class="grid grid-cols-1 gap-6 h-min">
            <div class="bg-gradient-to-r from-pink-500 to-violet-600 bg-clip-text text-transparent text-5xl  py-1 maven-pro-500">Empowering Learners Globally</div>
            <div class="text-2xl leading-8 font-light">
                Eovix has equipped thousands of students and professionals with the skills they need to excel in the rapidly changing world. Through our specialized courses in artificial intelligence, green technology, and sustainability, learners have gained valuable knowledge that they’ve applied in their careers, businesses, and communities.
            </div>
        ...
        <div class="grid grid-cols-1 gap-6 h-min">
            <div class="bg-gradient-to-r from-pink-500 to-violet-600 bg-clip-text text-transparent text-5xl  py-1 maven-pro-500">Sustainable Business Transformation</div>
            <div class="text-2xl leading-8 font-light">
                We partner with businesses across various industries to help them implement sustainable practices that not only reduce their environmental impact but also drive innovation and profitability. From renewable energy adoption to waste reduction initiatives, our corporate sustainability programs have led to significant positive outcomes for our partners.
            </div>
        ...
        <div class="grid grid-cols-1 gap-6 h-min">
            <div class="bg-gradient-to-r from-pink-500 to-violet-600 bg-clip-text text-transparent text-5xl  py-1 maven-pro-500">Advancing Sustainability Education in Schools and Universities</div>
            <div class="text-2xl leading-8 font-light">
                Eovix collaborates with educational institutions to integrate sustainability into their curricula, helping students develop a deep understanding of environmental issues and innovative solutions. Our partnerships with schools and universities have not only enhanced learning experiences but also created lasting changes in how institutions approach sustainability.
            </div>
        ...
        <div class="grid grid-cols-1 gap-6 h-min">
            <div class="bg-gradient-to-r from-pink-500 to-violet-600 bg-clip-text text-transparent text-5xl  py-1 maven-pro-500">Corporate Social Responsibility (CSR) and ESG Impact</div>
            <div class="text-2xl leading-8 font-light">
                Eovix has been instrumental in helping corporations meet their Corporate Social Responsibility (CSR) and Environmental, Social, and Governance (ESG) goals. Our programs help businesses not only comply with regulations but also take proactive steps toward becoming leaders in sustainability and ethical governance.
            </div>
        ...
        <div class="grid grid-cols-1 gap-6 h-min">
            <div class="bg-gradient-to-r from-pink-500 to-violet-600 bg-clip-text text-transparent text-5xl  py-1 maven-pro-500">Real-World Projects and Community Initiatives</div>
            <div class="text-2xl leading-8 font-light">
                Through our hands-on programs, Eovix has empowered learners and organizations to work on real-world projects that create tangible benefits for their communities and the environment.
            </div>
        ...
        <div class="grid grid-cols-1 gap-6 h-min">
            <div class="bg-gradient-to-r from-pink-500 to-violet-600 bg-clip-text text-transparent text-5xl  py-1 maven-pro-500">Leadership in Sustainability and Technology</div>
            <div class="text-2xl leading-8 font-light">
                Eovix is proud to be recognized as a leader in sustainability education and emerging technology training. Through our programs and partnerships, we are shaping the future of industries by equipping leaders and professionals with the knowledge they need to drive innovation and sustainable practices within their organizations.
            </div>
        ...
        <div class="grid grid-cols-1 gap-6 h-min">
            <div class="bg-gradient-to-r from-pink-500 to-violet-600 bg-clip-text text-transparent text-5xl  py-1 maven-pro-500">Measurable Outcomes and Lasting Impact</div>
            <div class="text-2xl leading-8 font-light">
                We believe in tracking the results of our initiatives and ensuring that our programs lead to long-term, sustainable impact. Whether through improved learning outcomes, reduced carbon footprints, or enhanced operational efficiency, we are committed to creating measurable, lasting change.
            </div>
        ...
        <div class="grid grid-cols-1 gap-6 h-min">
            <div class="bg-gradient-to-r from-pink-500 to-violet-600 bg-clip-text text-transparent text-5xl  py-1 maven-pro-500">Our Commitment to the Future</div>
            <div class="text-2xl leading-8 font-light">
                At Eovix, we believe that our impact is measured by the positive changes we help create in the world. Whether we are empowering individuals with education or helping businesses adopt sustainable practices, our mission is to drive meaningful, lasting change.
            </div>
        </div>

        <div class="grid grid-cols-1 gap-6 h-min">
            <div class="bg-gradient-to-r from-pink-500 to-violet-600 bg-clip-text text-transparent text-5xl  py-1 maven-pro-500">Join us in creating a sustainable future</div>
            <div class="text-2xl leading-8 font-light">
                Explore our programs and partnerships, and learn how Eovix can help you make a real-world impact through education and sustainability initiatives. Together, we can create a better world for today and future generations.
            </div>
        </div>
